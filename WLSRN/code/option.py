...
# Dataset Setting
parser.add_argument('--dir_data', type=str, default='../../SEM', help='dataset directory')
...
parser.add_argument('--data_range', type=str, default='1-800/801-900', help='train/test data range')
...
parser.add_argument('--model', default='WLSRN', help='student model name')
parser.add_argument('--teacher', default="[Teacher]", type=str, help='teachers selected')
parser.add_argument('--student_n_resblocks', type=int, default=3, help='number of residual blocks')
